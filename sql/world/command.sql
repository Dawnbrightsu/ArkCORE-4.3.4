...
INSERT INTO `command` VALUES ('cheat status', 2, 'Syntax: .cheat status \n\nShows the cheats you currently have enabled.');
...
INSERT INTO `command` VALUES ('npc set data', 3, 'Syntax: .npc set data $field $data\nSets data for the selected creature. Used for testing Scripting');
INSERT INTO `command` VALUES ('learn all crafts', 2, 'Syntax: .learn crafts\r\n\r\nLearn all professions and recipes.');
INSERT INTO `command` VALUES ('learn all default', 1, 'Syntax: .learn all default [$playername]\r\n\r\nLearn for selected/$playername player all default spells for his race/class and spells rewarded by completed quests.');
INSERT INTO `command` VALUES ('learn all gm', 2, 'Syntax: .learn all gm\r\n\r\nLearn all default spells for Game Masters.');
INSERT INTO `command` VALUES ('learn all lang', 1, 'Syntax: .learn all lang\r\n\r\nLearn all languages');
INSERT INTO `command` VALUES ('learn all my class', 3, 'Syntax: .learn all my class\r\n\r\nLearn all spells and talents available for his class.');
INSERT INTO `command` VALUES ('learn all my pettalents', 3, 'Syntax: .learn all my pettalents\r\n\r\nLearn all talents for your pet available for his creature type (only for hunter pets).');
INSERT INTO `command` VALUES ('learn all my spells', 3, 'Syntax: .learn all my spells\r\n\r\nLearn all spells (except talents and spells with first rank learned as talent) available for his class.');
INSERT INTO `command` VALUES ('modify scale', 1, '.modify scale #scale\nModify size of the selected player or creature to \"normal scale\"*rate. If no player or creature is selected, modify your size.\n#rate may range from 0.1 to 10.');
INSERT INTO `command` VALUES ('learn all my talents', 3, 'Syntax: .learn all my talents\r\n\r\nLearn all talents (and spells with first rank learned as talent) available for his class.');
...
INSERT INTO `command` VALUES ('modify speed swim', 1, 'Syntax: .modify speed swim #rate\r\n\r\nModify the swim speed of the selected player to \"normal swim speed\"*rate. If no player is selected, modify your speed.\r\n\r\n #rate may range from 0.1 to 50.');
...
INSERT INTO `command` VALUES ('modify reputation', 2, 'Syntax: .modify reputation #repId (#repvalue | $rankname [#delta])\nSets the selected players reputation with faction #repId to #repvalue or to $reprank.\nIf the reputation rank name is provided, the resulting reputation will be the lowest reputation for that rank plus the delta amount, if specified.\nYou can use \'.pinfo rep\' to list all known reputation ids, or use \'.lookup faction $name\' to locate a specific faction id.');
...
INSERT INTO `command` VALUES ('modify speed backwalk', 1, 'Syntax: .modify speed backwalk #rate\r\n\r\nModify the speed of the selected player while running backwards to \"normal walk back speed\"*rate. If no player is selected, modify your speed.\r\n\r\n #rate may range from 0.1 to 50.');
...
INSERT INTO `command` VALUES ('modify speed all', 1, 'Syntax: .modify aspeed #rate\r\n\r\nModify all speeds -run,swim,run back,swim back- of the selected player to \"normalbase speed for this move type\"*rate. If no player is selected, modify your speed.\r\n\r\n #rate may range from 0.1 to 50.');
...
INSERT INTO `command` VALUES ('npc add move', 2, 'Syntax: .npc add move #creature_guid [#waittime]\r\n\r\nAdd your current location as a waypoint for creature with guid #creature_guid. And optional add wait time.');
INSERT INTO `command` VALUES ('npc set allowmove', 3, 'Syntax: .npc set allowmove\r\n\r\nEnable or disable movement creatures in world. Not implemented.');
INSERT INTO `command` VALUES ('npc set entry', 3, 'Syntax: .npc set entry $entry\nSwitch selected creature with another entry from creature_template. - New creature.id value not saved to DB.');
INSERT INTO `command` VALUES ('npc set level', 2, 'Syntax: .npc set level #level\r\n\r\nChange the level of the selected creature to #level.\r\n\r\n#level may range from 1 to (CONFIG_MAX_PLAYER_LEVEL) + 3.');
...
INSERT INTO `command` VALUES ('npc delete item', 2, 'Syntax: .npc delete item #itemId\r\n\r\nRemove item #itemid from item list of selected vendor.');
INSERT INTO `command` VALUES ('npc set factionid', 2, 'Syntax: .npc set factionid #factionid\r\n\r\nSet the faction of the selected creature to #factionid.');
INSERT INTO `command` VALUES ('wpgps', 3, 'Syntax: .wpgps\n\nOutput current position to sql developer log as partial SQL query to be used in pathing');
INSERT INTO `command` VALUES ('npc set phase', 2, 'Syntax: .npc set phase #phasemask\r\n\r\nSelected unit or pet phasemask changed to #phasemask with related world vision update for players. In creature case state saved to DB and persistent. In pet case change active until in game phase changed for owner, owner re-login, or GM-mode enable/disable..');
INSERT INTO `command` VALUES ('npc set spawndist', 2, 'Syntax: .npc set spawndist #dist\r\n\r\nAdjust spawndistance of selected creature to dist.');
INSERT INTO `command` VALUES ('npc set spawntime', 2, 'Syntax: .npc set spawntime #time \r\n\r\nAdjust spawntime of selected creature to time.');
INSERT INTO `command` VALUES ('npc follow', 2, 'Syntax: .npc follow start\r\n\r\nSelected creature start follow you until death/fight/etc.');
INSERT INTO `command` VALUES ('npc follow stop', 2, 'Syntax: .npc follow stop\r\n\r\nSelected creature (non pet) stop follow you.');
INSERT INTO `command` VALUES ('npc info', 3, 'Syntax: .npc info\r\n\r\nDisplay a list of details for the selected creature.\r\n\r\nThe list includes:\r\n- GUID, Faction, NPC flags, Entry ID, Model ID,\r\n- Level,\r\n- Health (current/maximum),\r\n\r\n- Field flags, dynamic flags, faction template, \r\n- Position information,\r\n- and the creature type, e.g. if the creature is a vendor.');
INSERT INTO `command` VALUES ('npc set flag', 2, 'Syntax: .npc set flag #npcflag\r\n\r\nSet the NPC flags of creature template of the selected creature and selected creature to #npcflag. NPC flags will applied to all creatures of selected creature template after server restart or grid unload/load.');
...
INSERT INTO `command` VALUES ('reload wp_data', 3, 'Syntax: .reload wp_data will reload waypoint_data table.');
INSERT INTO `command` VALUES ('npc set link', 2, 'Syntax: .npc set link $creatureGUID\r\n\r\nLinks respawn of selected creature to the condition that $creatureGUID defined is alive.');
INSERT INTO `command` VALUES ('npc set model', 2, 'Syntax: .npc set model #displayid\r\n\r\nChange the model id of the selected creature to #displayid.');
...
INSERT INTO `command` VALUES ('reload spell_proc', 3, 'Syntax: .reload spell_proc\nReload spell_proc table.');
...
INSERT INTO `command` VALUES ('debug areatriggers', 1, 'Syntax: .debug areatriggers\nToggle debug mode for areatriggers. In debug mode GM will be notified if reaching an areatrigger');
INSERT INTO `command` VALUES ('learn', 3, 'Syntax: .learn #spell [all]\r\n\r\nSelected character learn a spell of id #spell. If \'all\' provided then all ranks learned.');
INSERT INTO `command` VALUES ('npc add item', 2, 'Syntax: .npc add item #itemId <#maxcount><#incrtime><#extendedcost>r\r\n\r\nAdd item #itemid to item list of selected vendor. Also optionally set max count item in vendor item list and time to item count restoring and items ExtendedCost.');
INSERT INTO `command` VALUES ('npc add formation', 1, 'Syntax: .npc add formation $leader\nAdd selected creature to a leader\'s formation.');
...
INSERT INTO `command` VALUES ('disable remove spell', 3, 'Syntax: .disable remove spell $entry');
INSERT INTO `command` VALUES ('reload all item', 3, 'Syntax: .reload all item\nReload page_text, item_enchantment_table tables.');
INSERT INTO `command` VALUES ('reload all area', 3, 'Syntax: .reload all area\r\n\r\nReload areatrigger_teleport, areatrigger_tavern, game_graveyard_zone tables.');
INSERT INTO `command` VALUES ('reload achievement_reward', 3, 'Syntax: .reload achievement_reward\nReload achievement_reward table.');
INSERT INTO `command` VALUES ('reload all achievement', 3, 'Syntax: .reload all achievement\r\n\r\nReload achievement_reward, achievement_criteria_data tables.');
INSERT INTO `command` VALUES ('server set loglevel', 4, 'Syntax: .server set loglevel $facility $name $loglevel. $facility can take the values: appender (a) or logger (l). $loglevel can take the values: disabled (0), trace (1), debug (2), info (3), warn (4), error (5) or fatal (6)');
INSERT INTO `command` VALUES ('reload achievement_criteria_data', 3, 'Syntax: .reload achievement_criteria_data\nReload achievement_criteria_data table.');
INSERT INTO `command` VALUES ('reload access_requirement', 3, 'Syntax: .reload access_requirement\nReload access_requirement table.');
INSERT INTO `command` VALUES ('reload vehicle_template_accessory', 3, 'Syntax: .reload vehicle_template_accessory\n\nReloads entry-based vehicle accessory definitions from the database.');
INSERT INTO `command` VALUES ('reload vehicle_accessory', 3, 'Syntax: .reload vehicle_accessory\n\nReloads GUID-based vehicle accessory definitions from the database.');
...
INSERT INTO `command` VALUES ('ticket reset', 3, 'Syntax: .ticket reset\nRemoves all closed tickets and resets the counter, if no pending open tickets are existing.');
INSERT INTO `command` VALUES ('reload waypoint_data', 3, 'Syntax: .reload waypoint_data will reload waypoint_data table.');
INSERT INTO `command` VALUES ('group disband', 3, 'Syntax: .group disband [$characterName]\n\nDisbands the given character\'s group.');
INSERT INTO `command` VALUES ('group remove', 3, 'Syntax: .group remove [$characterName]\n\nRemoves the given character from his group.');
INSERT INTO `command` VALUES ('group leader', 3, 'Syntax: .group leader [$characterName]\n\nSets the given character as his group\'s leader.');
INSERT INTO `command` VALUES ('group', 3, 'Syntax: .group $subcommand\nType .group to see the list of possible subcommands or .help group $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('debug moveflags', 3, 'Syntax: .debug moveflags [$newMoveFlags [$newMoveFlags2]]\r\nNo params given will output the current moveflags of the target');
INSERT INTO `command` VALUES ('reload locales_creature_text', 3, 'Syntax: .reload locales_creature_text\nReload locales_creature_text Table.');
INSERT INTO `command` VALUES ('morph', 2, 'Syntax: .morph #displayid\r\n\r\nChange your current model id to #displayid.');
INSERT INTO `command` VALUES ('modify arenapoints', 1, 'Syntax: .modify arenapoints #value\r\nAdd $amount arena points to the selected player.');
INSERT INTO `command` VALUES ('npc set movetype', 2, 'Syntax: .npc set movetype [#creature_guid] stay/random/way [NODEL]\r\n\r\nSet for creature pointed by #creature_guid (or selected if #creature_guid not provided) movement type and move it to respawn position (if creature alive). Any existing waypoints for creature will be removed from the database if you do not use NODEL. If the creature is dead then movement type will applied at creature respawn.\r\nMake sure you use NODEL, if you want to keep the waypoints.');
INSERT INTO `command` VALUES ('disable remove map', 3, 'Syntax: .disable remove map $entry');
INSERT INTO `command` VALUES ('disable remove battleground', 3, 'Syntax: .disable remove battleground $entry');
INSERT INTO `command` VALUES ('disable remove achievement_criteria', 3, 'Syntax: .disable remove achievement_criteria $entry');
INSERT INTO `command` VALUES ('disable add vmap', 3, 'Syntax: .disable add vmap $entry $flag $comment');
INSERT INTO `command` VALUES ('disable remove quest', 3, 'Syntax: .disable remove quest $entry');
INSERT INTO `command` VALUES ('disable add outdoorpvp', 3, 'Syntax: .disable add outdoorpvp $entry $flag $comment');
INSERT INTO `command` VALUES ('disable add battleground', 3, 'Syntax: .disable add battleground $entry $flag $comment');
INSERT INTO `command` VALUES ('disable add achievement_criteria', 3, 'Syntax: .disable add achievement_criteria $entry $flag $comment');
INSERT INTO `command` VALUES ('disable add spell', 3, 'Syntax: .disable add spell $entry $flag $comment');
INSERT INTO `command` VALUES ('disable add map', 3, 'Syntax: .disable add map $entry $flag $comment');
INSERT INTO `command` VALUES ('disable add quest', 3, 'Syntax: .disable add quest $entry $flag $comment');
INSERT INTO `command` VALUES ('bf stop', 3, 'Syntax: .bf stop #battleid');
INSERT INTO `command` VALUES ('bf enable', 3, 'Syntax: .bf enable #battleid');
INSERT INTO `command` VALUES ('bf switch', 3, 'Syntax: .bf switch #battleid');
INSERT INTO `command` VALUES ('bf timer', 3, 'Syntax: .bf timer #battleid #timer');
...
INSERT INTO `command` VALUES ('learn all recipes', 2, 'Syntax: .learn all recipes [$profession]\r\rLearns all recipes of specified profession and sets skill level to max.\rExample: .learn all recipes enchanting');
INSERT INTO `command` VALUES ('npc add temp', 2, 'Syntax: .npc add temp\r\n\r\nAdds temporary NPC, not saved to database.');
...
INSERT INTO `command` VALUES ('reload auctions', 3, 'Syntax: .reload auctions\nReload dynamic data tables from the database.');
INSERT INTO `command` VALUES ('reload mail_level_reward', 3, 'Syntax: .reload mail_level_reward\nReload mail_level_reward table.');
INSERT INTO `command` VALUES ('reload smart_scripts', 3, 'Syntax: .reload smart_scripts\nReload smart_scripts table.');
INSERT INTO `command` VALUES ('disable remove outdoorpvp', 3, 'Syntax: .disable remove outdoorpvp $entry');
INSERT INTO `command` VALUES ('disable remove vmap', 3, 'Syntax: .disable remove vmap $entry');
INSERT INTO `command` VALUES ('debug phase', 1, 'Syntax: .debug phase\r\n\r\nSends a phase debug report of a player to you.');
