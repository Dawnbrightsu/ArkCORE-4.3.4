...
INSERT INTO `areatrigger_teleport` VALUES (119, 'DeadMines Instance Start', 0, -11208.3, 1672.52, 24.66, 4.55217);
...
INSERT INTO `areatrigger_teleport` VALUES (242, 'Razorfen Kraul Instance Start', 1, -4464.92, -1666.24, 81.8928, 4.28827);
...
INSERT INTO `areatrigger_teleport` VALUES (259, 'Blackphantom Deeps Instance Start', 1, 4247.74, 745.879, -24.5299, 4.5828);
INSERT INTO `areatrigger_teleport` VALUES (286, 'Uldaman Entrance', 70, -226.8, 49.09, -46.03, 1.39);
INSERT INTO `areatrigger_teleport` VALUES (288, 'Uldaman Instance Start', 0, -6066.73, -2955.63, 209.776, 3.20443);
...
INSERT INTO `areatrigger_teleport` VALUES (444, 'Razorfen Downs Instance Start', 1, -4658.12, -2526.35, 81.492, 1.25978);
INSERT INTO `areatrigger_teleport` VALUES (446, 'Altar of Atal\'Hakkar Entrance', 109, -319.24, 99.9, -131.85, 3.19);
INSERT INTO `areatrigger_teleport` VALUES (448, 'Altar Of Atal\'Hakkar Instance Start', 0, -10175.1, -3995.15, -112.9, 2.95938);
INSERT INTO `areatrigger_teleport` VALUES (503, 'Stockades Instance', 0, -8764.83, 846.075, 87.4842, 3.77934);
...
INSERT INTO `areatrigger_teleport` VALUES (882, 'Uldaman Instance End', 0, -6620.48, -3765.19, 266.226, 3.13531);
INSERT INTO `areatrigger_teleport` VALUES (902, 'Uldaman Exit', 70, -214.02, 383.607, -38.7687, 0.5);
INSERT INTO `areatrigger_teleport` VALUES (922, 'Zul\'Farrak Instance Start', 1, -6796.49, -2890.77, 8.88063, 3.30496);
...
INSERT INTO `areatrigger_teleport` VALUES (1470, 'Blackrock Spire - Searing Gorge Instance', 0, -7524.19, -1230.13, 285.743, 2.09544);
INSERT INTO `areatrigger_teleport` VALUES (1472, 'Blackrock Dephts - Searing Gorge Instance', 0, -7179.63, -923.667, 166.416, 1.84097);
...
INSERT INTO `areatrigger_teleport` VALUES (2221, 'Stratholme - Eastern Plaguelands Instance (Inside)', 0, 3235.46, -4050.6, 108.45, 1.93522);
...
INSERT INTO `areatrigger_teleport` VALUES (2568, 'Scholomance Instance', 0, 1275.05, -2552.03, 90.3994, 3.6631);
...
INSERT INTO `areatrigger_teleport` VALUES (3126, 'Maraudon', 1, -1186.98, 2875.95, 85.7258, 1.78443);
...
INSERT INTO `areatrigger_teleport` VALUES (3186, 'Dire Maul', 429, -62.9658, 159.867, -3.46206, 3.14788);
...
INSERT INTO `areatrigger_teleport` VALUES (3928, 'Zul\'Gurub Entrance ', 309, -11916.1, -1230.53, 92.5334, 4.71867);
INSERT INTO `areatrigger_teleport` VALUES (3930, 'Zul\'Gurub Exit ', 0, -11916.3, -1208.37, 92.2868, 1.61792);
...
INSERT INTO `areatrigger_teleport` VALUES (4008, 'Ruins Of Ahn\'Qiraj (Outside)', 509, -8429.74, 1512.14, 31.9074, 2.58);
INSERT INTO `areatrigger_teleport` VALUES (4010, 'Ahn\'Qiraj Temple (Outside)', 531, -8231.33, 2010.6, 129.331, 0.929912);
INSERT INTO `areatrigger_teleport` VALUES (4012, 'Ahn\'Qiraj Temple (Inside)', 1, -8242.67, 1992.06, 129.072, 4.03066);
...
INSERT INTO `areatrigger_teleport` VALUES (4354, 'Dark Portal To Outland', 530, -248.149, 921.875, 84.3885, 1.58415);
...
INSERT INTO `areatrigger_teleport` VALUES (4386, 'Sunstrider Isle to Eastern Plaguelands', 0, 3476.36, -4493.36, 137.49, 2.25566);
INSERT INTO `areatrigger_teleport` VALUES (4397, 'Shadow Labyrinth (Exit)', 530, -3645.06, 4943.62, -101.048, 6.27058);
INSERT INTO `areatrigger_teleport` VALUES (4399, 'Sethekk Halls (Exit)', 530, -3361.96, 4660.41, -101.048, 1.65638);
INSERT INTO `areatrigger_teleport` VALUES (4401, 'Mana Tombs (Exit)', 530, -3079.81, 4943.04, -101.047, 3.16432);
INSERT INTO `areatrigger_teleport` VALUES (4403, 'Auchenai Crypts (Exit)', 530, -3362.22, 5225.77, -101.049, 4.67224);
...
INSERT INTO `areatrigger_teleport` VALUES (5181, 'Culling of Stratholme (exit)', 1, -8756.87, -4459.29, -200.73, 1.32);
...
INSERT INTO `areatrigger_teleport` VALUES (5276, 'Gundrak (exit - 3)', 571, 6702.47, -4660.55, 441.568, 0.75);
INSERT INTO `areatrigger_teleport` VALUES (5233, 'Gundrak (exit - 4)', 571, 6970.02, -4402.09, 441.578, 3.845);
INSERT INTO `areatrigger_teleport` VALUES (4614, 'The Mechanar', 530, 2869.89, 1552.76, 252.159, 0.733993);
INSERT INTO `areatrigger_teleport` VALUES (4612, 'The Botanica', 530, 3407.11, 1488.48, 182.838, 2.50112);
INSERT INTO `areatrigger_teleport` VALUES (6011, 'Blackrock Caverns (Exit)', 0, -7571.42, -1320.84, 246.382, 1.638);
INSERT INTO `areatrigger_teleport` VALUES (6108, 'Blackrock Caverns (Enterance)', 645, 211.15, 1131.12, 205.8, 4.6767);
INSERT INTO `areatrigger_teleport` VALUES (6177, 'Grim Batol (Exit)', 0, -4053.51, -3447.71, 283.404, 3.44519);
INSERT INTO `areatrigger_teleport` VALUES (6179, 'Grim Batol (Enterance)', 670, -626.595, -180.003, 272.097, 4.9288);
INSERT INTO `areatrigger_teleport` VALUES (6194, 'The Stonecore (Exit)', 646, 1027.44, 628.709, 157.141, 1.82351);
INSERT INTO `areatrigger_teleport` VALUES (6196, 'The Stonecore (Enterance)', 725, 827.012, 985.966, 317.375, 0.006879);
INSERT INTO `areatrigger_teleport` VALUES (6197, 'Throne of the Tides (Exit)', 0, -5599.09, 5412.06, -1798.15, 2.40455);
INSERT INTO `areatrigger_teleport` VALUES (6201, 'Throne of the Tides (Enterance)', 643, -624.44, 807.108, 246.295, 6.26158);
INSERT INTO `areatrigger_teleport` VALUES (6485, 'Halls of Origination (Enterance)', 644, -954.217, 461.686, 51.9705, 1.55269);
INSERT INTO `areatrigger_teleport` VALUES (6487, 'Halls of Origination (Exit)', 1, -10211, -1837.83, 20.1281, 6.25565);
INSERT INTO `areatrigger_teleport` VALUES (6610, 'The Vortex Pinnacle (Exit)', 1, -11516.5, -2312.36, 608.65, 0.673829);
INSERT INTO `areatrigger_teleport` VALUES (6612, 'The Vortex Pinnacle (Enterance)', 657, -339.959, 12.9507, 626.98, 3.95129);
INSERT INTO `areatrigger_teleport` VALUES (6620, 'Lost City of the Tol\'vir (Enterance)', 755, -10701.4, -1312.92, 18.5184, 3.41487);
INSERT INTO `areatrigger_teleport` VALUES (6488, 'Lost City of the Tol\'vir (Exit)', 1, -10678.3, -1306.81, 17.3417, 0.220624);
INSERT INTO `areatrigger_teleport` VALUES (6341, 'Bastion of Twilight (Exit)', 0, -4888.41, -4239.17, 827.763, 5.21704);
INSERT INTO `areatrigger_teleport` VALUES (6354, 'Bastion of Twilight (Enterance)', 671, -565.082, -531.977, 890.593, 6.2334);
INSERT INTO `areatrigger_teleport` VALUES (6580, 'Blackwing Descent (Exit)', 0, -7539.44, -1196.08, 477.769, 5.01914);
INSERT INTO `areatrigger_teleport` VALUES (6581, 'Blackwing Descent (Enterance)', 669, -341.186, -226.004, 193.514, 6.28049);
INSERT INTO `areatrigger_teleport` VALUES (6618, 'Baradin Hold (Exit)', 732, -1266.98, 1049.99, 106.995, 0.014455);
INSERT INTO `areatrigger_teleport` VALUES (6664, 'Baradin Hold (Enterance)', 757, 165.2, 1337.02, 170.765, 0.034195);
INSERT INTO `areatrigger_teleport` VALUES (6672, 'Throne of the four Winds (Enterance)', 754, -306.39, 816.64, 199.48, 6.3);
INSERT INTO `areatrigger_teleport` VALUES (6673, 'Throne of the four Winds (Exit)', 1, -11355, 58.1568, 723.883, 5.01194);
INSERT INTO `areatrigger_teleport` VALUES (5879, 'Firelands Forgeworks (Exit)', 1, 5036.41, -2045.99, 1368.39, 5.2961);
INSERT INTO `areatrigger_teleport` VALUES (5880, 'Firelands Forgeworks (Enterance)', 1, 5029.45, -2029.36, 1148.97, 0.214575);
INSERT INTO `areatrigger_teleport` VALUES (5931, 'The Crucible of Flame (Enterance)', 1, 4679.1, -3675.53, 696.452, 1.3644);
INSERT INTO `areatrigger_teleport` VALUES (5937, 'The Crucible of Flame (Exit)', 1, 4653.99, -3688.44, 955.265, 2.38149);
INSERT INTO `areatrigger_teleport` VALUES (6864, 'Firelands (Enterance)', 720, -551.815, 320.05, 115.489, 5.94812);
INSERT INTO `areatrigger_teleport` VALUES (6866, 'Firelands (Exit)', 1, 3987.92, -2945.83, 1002.55, 5.11593);
INSERT INTO `areatrigger_teleport` VALUES (7151, 'Well of Eternity (Enterance)', 939, 3243.83, -5002.43, 194.094, 2.30634);
INSERT INTO `areatrigger_teleport` VALUES (7161, 'Well of Eternity (Exit)', 1, -8596.36, -4001.64, -205.547, 4.46226);
INSERT INTO `areatrigger_teleport` VALUES (7152, 'Endtime (Enterance)', 938, 3729.22, -410.887, 111.092, 1.79282);
INSERT INTO `areatrigger_teleport` VALUES (7162, 'Endtime (Exit)', 1, -8296.45, -4458.88, -208.441, 3.772);
INSERT INTO `areatrigger_teleport` VALUES (7154, 'Hour of Twilight (Enterance)', 940, 4929.25, 330.705, 103.976, 4.58467);
INSERT INTO `areatrigger_teleport` VALUES (7163, 'Hour of Twilight (Exit)', 1, -8289.69, -4580.73, -225.664, 1.64888);
INSERT INTO `areatrigger_teleport` VALUES (7155, 'Dragonsoul (Enterance)', 967, -2305.51, -2389.55, 84.4349, 6.14182);
INSERT INTO `areatrigger_teleport` VALUES (7164, 'Dragonsoul (Exit)', 1, -8269.14, -4514.72, -219.441, 3.5214);
