...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(ConfigMgr::GetStringDefault("Motd", "Welcome to a Arkcore Core Server."));
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outInfo(LOG_FILTER_SERVER_LOADING, "Loading Arkcore strings...");
...
void World::SendAutoBroadcast()
{
    ...
    msg = Arkcore::Containers::SelectRandomContainerElement(m_Autobroadcasts);
