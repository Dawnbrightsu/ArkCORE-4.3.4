...
class spell_sha_bloodlust : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_bloodlust_SpellScript : public SpellScript
        {
            ...
            {
                targets.remove_if(Arkcore::UnitAuraCheck(true, SHAMAN_SPELL_SATED));
                targets.remove_if(Arkcore::UnitAuraCheck(true, HUNTER_SPELL_INSANITY));
                targets.remove_if(Arkcore::UnitAuraCheck(true, MAGE_SPELL_TEMPORAL_DISPLACEMENT));
            }
...
class spell_sha_heroism : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_heroism_SpellScript : public SpellScript
        {
            ...
            void RemoveInvalidTargets(std::list<WorldObject*>& targets)
            {
                targets.remove_if(Arkcore::UnitAuraCheck(true, SHAMAN_SPELL_EXHAUSTION));
                targets.remove_if(Arkcore::UnitAuraCheck(true, HUNTER_SPELL_INSANITY));
                targets.remove_if(Arkcore::UnitAuraCheck(true, MAGE_SPELL_TEMPORAL_DISPLACEMENT));
            }
